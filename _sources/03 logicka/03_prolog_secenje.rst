...
Минимум се може дефинисати на следећи начин (релацијски оператори
...
Израчунавање резултата упита ``min(3, 5, M).`` и упита ``min(5, 3,
...
Приликом упита ``?- min(3, 5, M)`` извршиће се унификација којом ће се
...
Вредност минимума бројева 3 и 5 можемо израчунати у било ком
редоследу да су задати.

- Упит ``?- min(3, 5, M)`` се извршава на већ описани начин, добија се
  резултат ``M=3`` и због сечења се не траже друга решења.
- Упит ``?- min(5, 3, M)`` се извршава тако што се унификује ``X`` са
